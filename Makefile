...
all: $(LIB_DIR)/t2fs.o $(LIB_DIR)/disk.o $(LIB_DIR)/aux.o $(LIB_DIR)/parse.o
	ar rcs $(LIB_DIR)/libt2fs.a $(LIB_DIR)/t2fs.o $(LIB_DIR)/apidisk.o $(LIB_DIR)/bitmap2.o $(LIB_DIR)/disk.o $(LIB_DIR)/aux.o $(LIB_DIR)/parse.o
...
# TESTE #
teste: $(BIN_DIR)/display $(BIN_DIR)/disk $(BIN_DIR)/t2fs $(BIN_DIR)/parse
	$(BIN_DIR)/parse
